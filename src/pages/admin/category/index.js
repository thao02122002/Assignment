...
const CategoryHome = {
    async  render() {
        ...
        <h1 class="col-span-11  ">Quản lý Danh Mục</h1>
        <a href="/admin/category/add"><button type="submit" class="col-span-1 p-2 border border-black">Thêm Mới</button></a>
        </div>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <a href="/admin/category/${post.id}/edit" class="text-indigo-600 hover:text-indigo-900"><button class="">Edit</button></a>/<a href="#" class="text-indigo-600 hover:text-indigo-900"><button data-id=${post.id} class="btn btn-remove">Dell</button></a>
                    </td>
                  </tr>
