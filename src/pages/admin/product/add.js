...
const addProduct = {
    async  render() {
        ...
        ${navAdmin.render()}
        <h1 class="pt-40 pb-4">Thêm Sản Phẩm</h1>
        <div>
                  ...
                  <div class="grid grid-cols-3 gap-6">
                    <div class="col-span-3 sm:col-span-2">
                      ...
                      <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" id="name-post" name="company-website" id="company-website" class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="">
                      </div>
                    </div>
                  </div>
...
<div>
      ...
      <div>
                    ...
                    <div class="mt-1">
                      <textarea id="price-post" name="about" rows="3" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md" placeholder=""></textarea>
                    </div>
